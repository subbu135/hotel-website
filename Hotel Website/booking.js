...
function setAmt() {
    ...
    if (pckgType == 1) {
        totalamt.value = (1999 * parseInt(numofRooms.value)) + " (Rupees)";;
    }
    else if (pckgType == 2) {
        totalamt.value = (2995 * parseInt(numofRooms.value))  + " (Rupees)";;
    }
    else if (pckgType == 3) {
        totalamt.value = (3395 * parseInt(numofRooms.value)) + "(Rupees)";;
    }
    else if (pckgType == 4) {
        totalamt.value = (9999 * parseInt(numofRooms.value)) + " (Rupees)";
    }
